...
import com.example.remainder.database.entity.SentenceEntity.Companion.TABLE_NAME
import org.json.JSONObject

@Entity(tableName = TABLE_NAME)
data class SentenceEntity(@PrimaryKey(autoGenerate = true) val idx: Int,
                          @ColumnInfo(name = "content") var content: String,
                          @ColumnInfo(name = "tag_idx") var tag_idx: Int) : BaseEntity {

    companion object {
        const val TABLE_NAME = "sentence"
    }
